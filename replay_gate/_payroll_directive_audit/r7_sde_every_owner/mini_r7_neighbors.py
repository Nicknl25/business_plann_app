"""Item 7 / R4 neighbor check (mini audit instrument, 2026-09-10, adapted from VS shape, run from my own worktree).
...
Usage: python -u mini_r7_neighbors.py --root <repo-or-worktree> --label before|after --out <dir>
...
def main() -> int:
  print("mini_r7_neighbors start", flush=True)
