...
BLESSED_SURFACES = {
    ...
    "R32": {
        "at": "3ce7338",
        "workbook_formulas": "86ee8e861bca",
    },
    "R49": {
        "at": "3ce7338",
        "workbook_text": "20ba34cac621",
    },
}
...
REGRESSIONS = [
    ...
    Leg("R49", "INVARIANT", "workbook-text-surface",
        ...
        proof_note=("RE-BLESSED 2026-08-21f (baseline d3e8efe -> aa014c7, VS, CapEx "
                    ...
                    "constant (surface.py did not change in that range, checked). "
                    "The surface moved at FIVE of them - 2757e22, b7586ca, "
                    "ef62181, a46e5f8, d3e8efe - and every one of those five has "
                    "a --prove re-bless recorded below. NO commit shipped moved "
                    "text unchecked. The other seven left the digest byte-identical "
                    "(4d5d8148 across dbe82ba/f8c145b, 70862e7b across "
                    "2757e22..a1d0299, defefe5d across b7586ca/1b35f3d, 2742f45c "
                    "across ef62181/35df1d2), so a bare green on those was CORRECT "
                    "but UNEARNED - the leg would have said green either way, and "
                    "this sweep is what converts that from an assumption into a "
                    "measurement. The one case where bare green covered moved text "
                    "was a46e5f8 during the session itself, caught by --prove "
                    "minutes later and never used as final evidence. Bare mode now "
                    "compares against BLESSED_SURFACES. "
                    "PREVIOUS: RE-BLESSED 2026-08-21d (baseline a46e5f8 -> d3e8efe, VS, R-DEBT-02 "
