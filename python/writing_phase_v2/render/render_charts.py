...
# revenue by line: Year-1 shares from derived, scaled to annual revenue (mix
# held constant beyond Y1). CONDITION: two lines or more - a single-line
# stack repeats the revenue chart and says nothing.
