...
_SYSTEM_PROMPT = (
  ...
  "The no-digit rule covers digits INSIDE names the client used - a ZIP "
  "code, a certification like AS9100, a loan program - so refer to those "
  "without the numeral (the neighbourhood, not the ZIP; 'the aerospace "
  "quality certification track', not the code). "
