...
SENTENCES: Tuple[Dict[str, object], ...] = (
  ...
  {"id": "S01", "section": "market_and_industry", "class": "INFERRED",
   "text": "{entity.state_name} has {market.state_establishments} establishments in {entity.naics_title} - one for every {market.residents_per_establishment_state} residents.",
   "needs": ["entity.state_name", "market.state_establishments", "entity.naics_title", "market.residents_per_establishment_state"]},
  {"id": "S02", "section": "market_and_industry", "class": "INFERRED",
   "text": "{entity.business_name} is one of {market.state_establishments} operators in its trade statewide, a {market.client_share_of_state_establishments} share of the field.",
   "needs": ["entity.business_name", "market.state_establishments", "market.client_share_of_state_establishments"]},
  {"id": "S03", "section": "market_and_industry", "class": "INFERRED",
   "text": "The typical establishment in this trade employs {market.emp_per_establishment_state} people in {entity.state_name}, against {industry.emp_per_establishment_national} nationally.",
   "needs": ["market.emp_per_establishment_state", "entity.state_name", "industry.emp_per_establishment_national"]},
  {"id": "S04", "section": "market_and_industry", "class": "INFERRED",
   "text": "Annual payroll per establishment runs {market.payroll_per_establishment_state} in the state versus {industry.payroll_per_establishment_national} across the country.",
   "needs": ["market.payroll_per_establishment_state", "industry.payroll_per_establishment_national"]},
  ...
  {"id": "S11", "section": "the_business", "class": "INFERRED",
  ...
  # ---- TRADE AREA (ACS) ---------------------------------------------------
  {"id": "S13", "section": "market_and_industry", "class": "INFERRED",
  ...
  {"id": "S14", "section": "market_and_industry", "class": "INFERRED",
  ...
  {"id": "S17", "section": "market_and_industry", "class": "INFERRED",
   "text": "Across the state there are {market.households_per_establishment_state} households for every establishment in the trade.",
   "needs": ["market.households_per_establishment_state"]},
  ...
  # ---- MODEL-DERIVED ------------------------------------------------------
  {"id": "S32", "section": "financial_plan", "class": "GROUNDED",
  ...
  {"id": "S34", "section": "financial_plan", "class": "GROUNDED",
  ...
  {"id": "S35", "section": "products_and_services", "class": "GROUNDED",
  ...
  {"id": "S36", "section": "operations_and_organisation", "class": "GROUNDED",
