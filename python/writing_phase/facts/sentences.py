...
SENTENCES: Tuple[Dict[str, object], ...] = (
  ...
  {"id": "S03", "section": "market_and_industry", "class": "INFERRED",
   "text": "The typical establishment in this trade employs {market.emp_per_establishment} people in {market.competition_geo_label}, against {industry.emp_per_establishment_national} nationally.",
   "needs": ["market.emp_per_establishment", "market.competition_geo_label", "industry.emp_per_establishment_national"]},
  ...
  {"id": "S17", "section": "market_and_industry", "class": "INFERRED",
   "text": "In {market.competition_geo_label} there are {market.households_per_establishment} households for every establishment in the trade.",
   "needs": ["market.competition_geo_label", "market.households_per_establishment"]},
