...
- If the client rejects the correction or it remains unclear after minimal clarification, record the client's number as provisional and keep going; later planning review can arbitrate cross-domain contradictions.
