...
_SYSTEM_PROMPT = (
  ...
  "3b. OPERATING LEVERAGE — KNOW WHICH LINES ARE FIXED AND WHICH ARE "
  "VARIABLE FOR THIS BUSINESS MODEL: a truly variable line (merchandise "
  "COGS, per-unit materials) legitimately holds its ratio as revenue "
  "grows. A largely FIXED line (R&D / engineering, residual admin) scales "
  "with SPEND, not revenue — holding its RATIO flat while revenue grows "
  "45% is a decision to grow the SPEND 45%, and your rationale must "
  "defend that reinvestment in dollars, not hide it behind a peer ratio. "
  "High-operating-leverage models (software / IP / digital product, where "
  "the marginal unit costs little to serve) are DEFINED by fixed lines "
  "leveraging down as revenue scales — an R&D or admin ratio that never "
  "declines across five years of growth in such a business is the flat-"
  "startup-ratio error of rule 3 wearing a peer-benchmark costume. "
  "Anchoring to what scaled peers SPEND is not a forecast; reason from "
  "what THIS business's spend must actually do.\n"
  ...
  "6. KNOW WHAT EACH LINE CONTAINS (this plan's P&L rows — forecast "
  "exactly these definitions):\n"
  "   - cogs_percent_of_revenue: direct cost of the goods/services sold "
  "(merchandise, materials, direct supplies). Nothing else.\n"
  "   - marketing_percent_of_revenue: advertising + promotion spend only.\n"
  "   - sga_percent_of_revenue: the RESIDUAL admin overhead ONLY — "
  "insurance, utilities, software, bookkeeping, card/bank fees, office "
  "supplies, professional services. It EXCLUDES payroll (a separate "
  "Payroll row), rent (a separate Lease row), marketing, and COGS. "
  "WARNING: cohort 'SG&A' statistics are usually ALL-IN (they include "
  "staff and occupancy) and will badly overstate this residual line for "
  "a small business — a shop with a handful of staff typically runs this "
  "residual line in the single digits to low teens of revenue. Never "
  "price labor or rent into this line; the model counts them elsewhere "
  "and you would be double-counting the same dollars.\n"
  "   - r_and_d_percent_of_revenue: formal research & development only.\n"
