...
# Phase 9 P3.24 — `_run_unified_convergence_openai` (formerly defined here,
# 2026-05-08 bypass in orchestrator.py per Phase 8) was deleted. The GPT
# planner step is no longer part of the live convergence path; the target-
# seeking orchestrator + restoration loop + GPT exhaustion handler is the
# authoritative replacement. See docs/architecture/p3_23c_unified_convergence_status.md.
