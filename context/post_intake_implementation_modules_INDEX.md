...
|---|---|---|---|---|
| 1 | Industry Baseline Resolver + Producer-Side Substitution | [post_intake_module_1_industry_baseline_resolver.md](post_intake_module_1_industry_baseline_resolver.md) | not_started | none (foundation) |
| 2 | Convergence Determinism + NAICS-Tightened Stage Ramp | [post_intake_module_2_convergence_determinism.md](post_intake_module_2_convergence_determinism.md) | not_started | M1 |
| 3 | GPT Contract NAICS Bounds + Finalize Realism Gate | [post_intake_module_3_finalize_realism_gate.md](post_intake_module_3_finalize_realism_gate.md) | not_started | M1 |
| 4 | Hardcoded Constants → Tables (cash policy, planning-mode, sequence-row columns) | [post_intake_module_4_table_migrations.md](post_intake_module_4_table_migrations.md) | not_started | none (parallel-safe) |
| 5 | GPT Reductions (delete maintenance_capex, replace easy wins) | [post_intake_module_5_gpt_reductions.md](post_intake_module_5_gpt_reductions.md) | not_started | M1, M3 |
