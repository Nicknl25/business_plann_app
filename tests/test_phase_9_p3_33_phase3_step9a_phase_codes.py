...
class PhaseCodeEnumTest(unittest.TestCase):
  def test_phase_code_has_twenty_phases(self) -> None:
    # 20 = 13 original + MODEL_INPUT_CONTRACT (P3.40 Contract 1)
    ...
    #    + INDUSTRY_BASELINE_CONTRACT (P3.40 Contract 6)
    #    + AMALGAMATED_SESSION_CONTRACT (P3.40 Contract 7 -- FINAL
    #      contract in the P3.40 sequence).
    self.assertEqual(len(PhaseCode), 20)
