...
Fix applied:
- Fix duplicate keys in _PLANNING_MODE_DEFAULTS by removing duplicated 'normalize' and 'rebalance' keys to prevent prompt leakage and enforce correct baseline non-authority language.
