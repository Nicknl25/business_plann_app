...
- Fix prompt payload leakage and baseline anchoring by removing direct inclusion of raw model views and strengthen non-authority language in later quarters
