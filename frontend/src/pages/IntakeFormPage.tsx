...
function IntakeFormPage() {
  ...
  function handleSubmit(values: IntakeValues) {
    (async () => {
      ...
      if (!targetMarketDone) {
        setSubmitError("Complete the target market conversation before submitting.");
        return;
      }
      if (!peopleDone) {
        setSubmitError("Complete the People & Capability conversation before submitting.");
        return;
      }
            ...
            <Card className="border border-slate-800/80 bg-slate-950/90">
              ...
              <CardContent className="space-y-4">
                <div className="mt-2 space-y-3 rounded-md border border-slate-800/80 bg-slate-950/60 p-3">
                  <div className="text-xs text-slate-300">
                    People &amp; capability consultation: GPT will help you capture
                    the key people behind the business and produce polished,
                    credibility-building paragraphs.
                  </div>
                  ...
                  {!consultDone ? (
                    ...
                    >
                      {peopleLoading
                        ? "Starting..."
                        : "Start people & capability conversation"}
                    </Button>
                  ) : null}
                  ...
                  {peopleDone ? (
                    <div className="rounded-md border border-emerald-500/30 bg-emerald-500/10 p-3 text-xs text-emerald-200">
                      People &amp; capability intake complete. Continue filling out
                      the rest of the form and click Submit intake.
                    </div>
                  ) : null}
                ...
                <div className="mt-2 space-y-3 rounded-md border border-slate-800/80 bg-slate-950/60 p-3">
                  ...
                  {!consultDone ? (
                    ...
                    >
                      {targetMarketLoading
                        ? "Starting..."
                        : "Start target market conversation"}
                    </Button>
                  ) : null}
                  ...
                  {targetMarketDone ? (
                    <div className="rounded-md border border-emerald-500/30 bg-emerald-500/10 p-3 text-xs text-emerald-200">
                      Target market intake complete. Continue filling out the
                      rest of the form and click Submit intake.
                    </div>
                  ) : null}
